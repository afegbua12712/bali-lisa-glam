...
export default defineConfig([
  ...
  {
    files: ['src/main.tsx', 'src/App.tsx', 'src/lib/supabase.ts', 'src/lib/store.ts', 'src/PaymentConfirmationEmailAction.tsx', 'src/lib/payment-email-state.ts', 'src/lib/order-email.ts'],
